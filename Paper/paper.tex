...
represents distributions: such a distribution consists of pair of
...
approach does not need to represent the collection of possible values
and their corresponding probabilities as list. %
In functional languages like Curry, the representation of several
results is commonly represented with nondeterminism instead of
...
For example, we can define a biased coin with a $30\%-70\%$ chance to
land on head and tail, respectively, as follows. %
